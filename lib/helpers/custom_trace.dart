class CustomTrace {
  ...
  void _parseTrace() {
    ...
    final frames = this._trace.toString().split("\n");
    ...
    */
    try {
      final columnStr = listOfInfo[2].replaceFirst(")", "");
      this.fileName = listOfInfo[0];
      this.lineNumber = int.tryParse(listOfInfo[1]) ?? -1;
      this.columnNumber = int.tryParse(columnStr) ?? -1;
    } catch (e) {
      print(e);
    }
  }
